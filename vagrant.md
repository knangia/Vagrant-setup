...
Install unzip bundle using the following command, since [vagrant.sh](https://raw.githubusercontent.com/AntonioMeireles/ClearLinux-packer/master/extras/clearlinux/setup/vagrant.sh) requires it.
```bash
